 ...
 */
final class Version20231019120541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student ADD n_id INT DEFAULT NULL, ADD classroom VARCHAR(255) NOT NULL, DROP classroom_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student ADD classroom_id INT NOT NULL, DROP n_id, DROP classroom');
    }
}
