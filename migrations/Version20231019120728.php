 ...
 */
final class Version20231019120728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student ADD classroom VARCHAR(255) NOT NULL, DROP n_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE student ADD n_id INT DEFAULT NULL, DROP classroom');
